...
export CHROME_EXECUTABLE=com.google.Chrome

# If you come from bash you might have to change your $PATH.
export PATH=/usr/lib/ccache/bin:$HOME/bin:$HOME/.local/bin:/usr/local/bin:$HOME/.cargo/bin:/opt/lampp/bin:$HOME/develop/flutter/bin:$PATH
